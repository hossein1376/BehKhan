...
func (c *bookServiceClient) GetBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/catalogue.BookService/GetBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalogue.BookService/GetBook",
	}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "catalogue.BookService",
	...
	Metadata: "services/catalogue/proto/cataloguePB/catalogue.proto",
}
